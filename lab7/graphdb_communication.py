...
if test=="world-cities":
    ...
    query_file="query_nobel-prize.txt"
    ...
    query_file="query_named_default.txt"
    query_file="query_named1.txt"
    query_file="query_named2.txt"
    query_file="query_named_all.txt"
    query_file="query_named_from.txt"    
    query = open(query_file, 'r').read()
